        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueChange = table.Column<decimal>(type: "decimal(12,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoryItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoryItems_InventoryItems_InventoryItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LotCost = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryItemCosts_InventoryItems_InventoryItemId",
                        column: x => x.InventoryItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "HistoryItemCosts",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HistoryItemId = table.Column<int>(type: "int", nullable: false),
                    InventoryItemCostId = table.Column<int>(type: "int", nullable: false),
                    QuantityChange = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoryItemCosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoryItemCosts_HistoryItemCosts_InventoryItemCostId",
                        column: x => x.InventoryItemCostId,
                        principalTable: "HistoryItemCosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HistoryItemCosts_HistoryItems_HistoryItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoryItemCosts_HistoryItemId",
                table: "HistoryItemCosts",
                column: "HistoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoryItemCosts_InventoryItemCostId",
                table: "HistoryItemCosts",
                column: "InventoryItemCostId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoryItems_InventoryItemId",
                table: "HistoryItems",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryItemCosts_InventoryItemId_ReceivedTimestamp_CurrentQuantity",
                table: "InventoryItemCosts",
                columns: new[] { "InventoryItemId", "ReceivedTimestamp", "CurrentQuantity" });
        }
